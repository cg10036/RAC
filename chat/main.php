...
?> readonly=""></td>
    ...
    <button type="button"style="width:200px; height:50px;" onclick="location.href='menu.php'">메뉴</button>
<button type="button" style="width:200px; height:50px;" onclick="location.href='tip.php'">팁</button>
